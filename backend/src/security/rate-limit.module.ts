import { ArgumentsHost, Catch, ExceptionFilter, HttpException, HttpStatus, Injectable, Module } from '@nestjs/common';
...
export class RateLimitExceededException extends HttpException {
  constructor(public readonly retryAfter:number){
    super({statusCode:HttpStatus.TOO_MANY_REQUESTS,message:'Muitas tentativas. Aguarde um pouco e tente novamente.',retry_after:retryAfter},HttpStatus.TOO_MANY_REQUESTS);
  }
}
...
@Module({ providers: [RateLimitService,{provide:APP_FILTER,useClass:RateLimitExceptionFilter}], exports: [RateLimitService] })
